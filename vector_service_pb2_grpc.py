...
class VectorServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ListVectors = channel.unary_stream(
                ...
                request_serializer=vector__service__pb2.ListVectorsRequest.SerializeToString,
                response_deserializer=vector__service__pb2.VectorResponse.FromString,
                _registered_method=True)
...
def add_VectorServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ListVectors': grpc.unary_stream_rpc_method_handler(
                    ...
                    request_deserializer=vector__service__pb2.ListVectorsRequest.FromString,
                    response_serializer=vector__service__pb2.VectorResponse.SerializeToString,
            ),
    }
...
class VectorService(object):
    ...
    def GetVector(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/vector_service.VectorService/GetVector',
            vector__service__pb2.VectorRequest.SerializeToString,
    ...
    def ListVectors(request,
        ...
        return grpc.experimental.unary_stream(
            ...
            target,
            '/vector_service.VectorService/ListVectors',
            vector__service__pb2.ListVectorsRequest.SerializeToString,
            vector__service__pb2.VectorResponse.FromString,
            options,
            channel_credentials,
            insecure,
